...
for epoch in range(num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(best_model_wts, r"D:\\Universidade\\Lic_IACD\\2023-2024\\2Semestre\\1Semestre\\Programacao\\Linguagens\\Python\\projeto\\Processamento-de-Dados-Audiovisuais\\Metricas\\best_resnet18_model.pth")
    else:
        counter += 1
        if counter >= patience:
